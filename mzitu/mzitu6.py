...
def mzitu_crawler(max_threads=10):
    ...
    def pageurl_crawler():
        ...
        while True:
            try:
                ...
                self.mkdir("/Users/shiqingwang/PycharmProjects/mzitu/images2/"+path)
                os.chdir("/Users/shiqingwang/PycharmProjects/mzitu/images2/"+path)
    ...
    def mkdir(path):
        ...
        isExists = os.path.exists(os.path.join("images2", path))
        if not isExists:
            print(u'建了一个名字叫做', path, u'的文件夹！')
            os.makedirs(os.path.join("images2", path))
            return True
        else:
